...
UAuraAttributeSet::UAuraAttributeSet()
{
	...
	//Resistances
	TagsToAttribute.Add(AuraTags.Attributes_Resistances_Physical, GetPhysicalResistanceAttribute);
	TagsToAttribute.Add(AuraTags.Attributes_Resistances_Fire, GetFireResistanceAttribute);
	TagsToAttribute.Add(AuraTags.Attributes_Resistances_Lightning, GetLightningResistanceAttribute);
	TagsToAttribute.Add(AuraTags.Attributes_Resistances_Arcane, GetArcaneResistanceAttribute);
